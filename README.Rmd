...
- Modular: Build a complex workflow from self-contained modules. Each module is tested separately.
- Easy development and debugging: Copies over a command that immediately enters the environment and script
- Resumable: Remembers the jobs that were started previously, and the workflow can thus be resumed at any point
